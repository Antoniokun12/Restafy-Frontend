<template>
  <q-layout view="hHh Lpr fFf">
    <q-page-container>
      <q-page class="q-pa-md">
        <div class="row items-center q-gutter-sm q-mb-md">
          <div class="text-h4 col-grow">Menú (Mesero)</div>
          <q-input
            v-model="search"
            dense
            filled
    ...
    <!-- Drawer del carrito -->
    <q-drawer v-model="showCart" side="right" overlay :width="360" bordered>
      <div class="q-pa-md">
        <div class="text-h5 q-mb-md">Pedido de Mesa</div>
...
function inc(it) {
  // reconstruye el producto mínimo para addItem (con foto para mantenerla)
  carrito.addItem(
    {
      _id: it.productoId,
